...
class AxesExample5 extends Chart
{
    protected function id(): string
    {
        return 'axes-example-5';
    }
    ...
    protected function datasets(): DatasetsContract
    {
        return new Datasets(
            ...
            new Dataset([
                ...
                new Entry(new Value(0.2, ''), new Label('2018')),
                new Entry(new Value(0.6, ''), new Label('2019')),
                new Entry(new Value(0.4, ''), new Label('2020')),
            ]),
        );
    }
